...
import os
import whitenoise # Diagnostic import to see if it changes the error location
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-z+2tmdujum4x2tx_k*kik)n43w62lr*)_*z(gk4bz5*g7ooztv')
